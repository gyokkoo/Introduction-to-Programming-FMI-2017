...
*   Да се състави програма, чрез която се проверява дали всички числа от първата редица са числа и
*   от втората редица, т.е. дали първата редица е подмножество на вторта редица.
*/
